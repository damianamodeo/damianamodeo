...
const color = {
  primary: `dark:focus:border-primary-400 focus:border-primary-500`,
  secondary: `dark:focus:border-secondary-400 focus:border-secondary-500`,
...
const labelColor = {
  primary: `peer-focus:text-primary-500 peer-focus:dark:text-primary-400 `,
  secondary: `peer-focus:text-secondary-500 peer-focus:dark:text-secondary-400 `,

...
const color = {
  primary: `bg-primary-500 hover:bg-primary-400 dark:bg-primary-400 dark:hover:bg-primary-500 `,
  secondary: `bg-secondary-500 hover:bg-secondary-400 dark:bg-secondary-400 dark:hover:bg-secondary-500 `,
    ...
    <button
      ...
      className={twMerge(
        `${button({
          ...
          width,
          className: '',
        })} ${circle && 'h-12 w-12 rounded-full p-0'} bg-red-500`
      )}
      ref={ref}
    >
      {children}
